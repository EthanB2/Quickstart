...
public class FConstants {
    static {
        ...
        FollowerConstants.xMovement = 62.2263;
        FollowerConstants.yMovement = 50.034;

        FollowerConstants.forwardZeroPowerAcceleration = -26.98;
        FollowerConstants.lateralZeroPowerAcceleration = -56.3848;
